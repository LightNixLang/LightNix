...
pub enum ParseErrorKind {
    ...
    InvalidImportElement,
    InvalidExportStatement,
    InvalidEnumDefine,
    InvalidEnumVariant,
    InvalidTypedef,
    InvalidInterfaceDefine,
    InvalidImplementsDefine,
    InvalidGenericParameter,
    InvalidWhereClause,
    InvalidUseElement,
    InvalidLetStatement,
    InvalidAssertStatement,
    InvalidMutationPolicy,
    InvalidAssignStatement,
    InvalidNestedAssignment,
    InvalidNestedAssignmentField,
